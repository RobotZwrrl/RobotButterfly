...
#define PRIORITY_NEOANIM_LOW        3
#define PRIORITY_NEOANIM_MID        4
#define PRIORITY_NEOANIM_HIGH       8
...
#define TASK_FREQ_PROXIMITY           1   // delay until (ms), each loop
...
#define TASK_FREQ_SENSORS           1   // delay until (ms), each loop
#define PRIORITY_SENSORS_LOW        3
#define PRIORITY_SENSORS_MID        6
#define PRIORITY_SENSORS_HIGH       8
...
#define PRIORITY_SERVOANIM_LOW        5
